...
t_amb = 38.0                    # 외기 공기온도[C]
t_air_evap_out = 13.0           # 증발기 출구 공기 건구온도[C]
rh_evap_in = 0.30               # 증발기 입구 공기 상대습도(%RH/100)
rh_evap_out = 0.95              # 증발기 출구 공기 상대습도(%RH/100)
AirVol = 500.0                  # 증발기 입구 풍량[CMH]
...
t_air_evap_in = t_amb + 2.0     # 증발기 입구 공기온도[C]. 건구온도. Heat Pickup 2.0[C]
...
SC_cond = 10.0                  # 응축기 출구 과냉각도[℃]
SH_comp = 10.0                  # 압축기 입구 과열도[℃]
P1 = 3.3                        # 압축기 입구 압력[barA]
# T1 = 17.0                       # 압축기 입구 온도[C]
